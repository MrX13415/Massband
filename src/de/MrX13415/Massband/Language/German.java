...
public class German extends Language {
    ...
    public German() {
        ...
        MB_ENABLED = ChatColor.GRAY + "Massband ist jetzt nun " + ChatColor.GOLD + "aktiviert";
        MB_DISABLED = ChatColor.GRAY + "Massband ist jetzt nun " + ChatColor.GOLD + "deaktiviert";

        THREADS_INTERUPT_TRY = ChatColor.GRAY + "Es wird versucht die Blockzählungen zu unterbrechen ...";
        THREADS_INTERUPT_FROM_PLAYER = Massband.consoleOutputHeader + ChatColor.RED + " Blöckzählung wurden von " + ChatColor.GOLD + "%s" + ChatColor.RED + " unterbrochen" ;
        THREADS_INTERUPT_TRY_ALL = Massband.consoleOutputHeader + ChatColor.RED + " Es wird versucht alle Blockzählungen zu unterbrechen ... (Anzahl: %s)";
        THREADS_INTERUPT_ERROR1 = Massband.consoleOutputHeader + ChatColor.RED + " Einige Blockzählungen konnten nicht unterbrochen werden! (Anzahl: %s). Bitte erneut versuchen.";
        THREADS_INTERUPT = ChatColor.GRAY + "Block zählungen unterbrochen";
        THREADS_INTERUPT_OK = Massband.consoleOutputHeader + ChatColor.RED + " Alle Blockzählungen wurden unterbrochen ! (noch übrig: %s)";
        THREADS_INTERUPT_NOTHING = ChatColor.RED + " Keine Blöckzählungen aktiv ...";

        COUNTBLOCK_TOTAL = ChatColor.WHITE + "Gesamter Inhalt: " + ChatColor.GOLD + "%s" + ChatColor.WHITE + " Böcke" + ChatColor.GRAY + " (ausser Luft)";
        ...
        COUNTBLOCK_ONCE = ChatColor.RED + "Es kann immer nur eine Blöckzählung gleichzeitig ausgeführt werden ! Bitte warten oder unterbrechen ...";
        COUNTBLOCK_BLPAGE_HEADER1 = ChatColor.GREEN + "= Blöckzählungen === page %s/%s =====================";
        COUNTBLOCK_BLPAGE_HEADER2 = ChatColor.GREEN + "= Blöckzählungen ==================================";
        ...
        COMMAND_MASSBAND_USAGE = ChatColor.GREEN + "Massband 2.8 - Ein Maßband - Befel: " + ChatColor.RED + "/massband" + ChatColor.GREEN + " oder " + ChatColor.RED + "/mb " + "\n"
                + ChatColor.RED + "/mb " + ChatColor.GOLD + "<enable|disable> " + ChatColor.GRAY + "Aktiviert/Deaktiviert Massband für einen selbst" + "\n"
                + ChatColor.RED + "/mb " + ChatColor.GOLD + "<simplemode|lengthmode|surfacemode> " + ChatColor.GRAY + "Schaltet zwischen den einzelnen Modis um" + "\n"
                ...
                + ChatColor.RED + "/mb stop " + ChatColor.GOLD + "" + ChatColor.GRAY + "Unterbricht die Blockzählung" + "\n"
                + ChatColor.RED + "/mb stopall " + ChatColor.GOLD + "" + ChatColor.GRAY + "Unterbricht alle Blockzählungen auf dem Server" + "\n"
                ...
                + ChatColor.RED + "/mb countBlocks " + ChatColor.GOLD + "" + ChatColor.GRAY + "Gibt die Anzahl der Blöcke in der Auswahl zurück (ausser Luft)" + "\n"
